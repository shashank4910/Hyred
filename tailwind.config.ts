  ...
  theme: {
    extend: {
      colors: {
        ...
        surface: '#f0f7f6',
        'surface-bright': '#f0f7f6',
        'surface-dim': '#cfe8e5',
        'surface-tint': '#006a65',
        'surface-variant': '#dceae8',
        'surface-card': '#ffffff',
        'surface-container': '#e4f0ee',
        'surface-container-low': '#eaf5f3',
        'surface-container-high': '#dceae8',
        'surface-container-highest': '#d4e5e2',
