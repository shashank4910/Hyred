...
export default function SpecularButton({
  ...
  useEffect(() => {
    ...
    void import('ogl').then(({ Renderer, Program, Mesh, Triangle, Color }) => {
      if (cancelled || !btnRef.current || !fxRef.current) return;
      ...
      canvas = oglGl.canvas as HTMLCanvasElement;
      oglGl.clearColor(0, 0, 0, 0);
      oglGl.enable(oglGl.BLEND);
      oglGl.blendFunc(oglGl.ONE, oglGl.ONE_MINUS_SRC_ALPHA);
      loseContext = () => {
      ...
      fxRef.current.appendChild(canvas);
